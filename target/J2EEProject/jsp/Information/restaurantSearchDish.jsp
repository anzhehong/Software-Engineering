            ...
            <div class="col-md-3 col-sm-4">
                <div class="panel panel-default">
                    <div class="panel-body text-center">
                        <!-- TODO: 需要的信息依次为：图片、饭馆名称、电话、种类、评分、价格，并且注意span标签后的br标签 -->
                        <img src="/camplus/images/dish/${var.key.dishImageId}.jpg" class="img-responsive">
                        <h4>${var.value.restaurantName}</h4>
                        <h4>${var.key.dishName}</h4>
                        <p><span class="glyphicon glyphicon-earphone" aria-hidden="true"></span> ${var.value.restaurantPhone}</p>
                        <div class="row">
                            <div class="col-xs-4">
                                <p><span class="glyphicon glyphicon-cutlery" aria-hidden="true"></span><br>${var.key.dishInfo}</p>
                            </div>
                            <div class="col-xs-4">
                                <p><span class="glyphicon glyphicon-star" aria-hidden="true"></span><br>${var.key.dishScore}</p>
                            </div>
                            <div class="col-xs-4">
                                <p><span class="glyphicon glyphicon-yen" aria-hidden="true"></span><br>${var.key.dishPrice}</p>
                            </div>
                        </div>
                    </div>
                </div>
